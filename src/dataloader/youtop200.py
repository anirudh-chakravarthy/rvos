...
from .base_youtop import Sequence, SequenceClip, Annotation, AnnotationClip, BaseLoader, Segmentation, SequenceClip_simple, AnnotationClip_simple
from misc.config_youtop200 import cfg, phase, db_read_sequences_train, db_read_sequences_val, db_read_sequences_test, db_read_sequences_trainval
...
class Youtop200Loader(MyDataset):
  """
